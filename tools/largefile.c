...
void usage();
int seq_write(int fd, long fileSize, long ioSize);
int seq_read(int fd, long fileSize, long ioSize);
int rand_write(int fd, long fileSize, long ioSize);
int rand_read(int fd, long fileSize, long ioSize);
